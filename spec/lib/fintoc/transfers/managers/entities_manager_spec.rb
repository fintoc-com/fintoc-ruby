...
RSpec.describe Fintoc::Transfers::Managers::EntitiesManager do
  ...
  before do
    ...
    allow(Fintoc::Transfers::Entity).to receive(:new)
  end
  ...
  describe '#get' do
    it 'fetches and builds an entity' do
      ...
      expect(Fintoc::Transfers::Entity).to have_received(:new).with(**first_entity_data, client:)
    end
  end
  ...
  describe '#list' do
    it 'fetches and builds a list of entities' do
      ...
      expect(Fintoc::Transfers::Entity).to have_received(:new).with(**first_entity_data, client:)
      expect(Fintoc::Transfers::Entity).to have_received(:new).with(**second_entity_data, client:)
    end
